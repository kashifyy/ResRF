...
import os
os.chdir('/content/gdrive/My Drive/Competitions/kaggle/diabetic-retinopathy-detection/input')#change dir
...
hist = model.fit(X_train, Y_train, epochs=20, validation_data=(X_valid, Y_valid), verbose=1)
